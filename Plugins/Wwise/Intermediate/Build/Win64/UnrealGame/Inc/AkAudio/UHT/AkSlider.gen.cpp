...
template<> AKAUDIO_API UScriptStruct* StaticStruct<FAkWwiseItemToControl>()
{
	...
	UAkSlider::~UAkSlider() {}
	struct Z_CompiledInDeferFile_FID_Users_diabo_OneDrive_Desktop_audioTest_Plugins_Wwise_Source_AkAudio_Classes_AkWaapiUMG_Components_AkSlider_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_diabo_OneDrive_Desktop_audioTest_Plugins_Wwise_Source_AkAudio_Classes_AkWaapiUMG_Components_AkSlider_h_Statics::ScriptStructInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_diabo_OneDrive_Desktop_audioTest_Plugins_Wwise_Source_AkAudio_Classes_AkWaapiUMG_Components_AkSlider_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAkSlider, UAkSlider::StaticClass, TEXT("UAkSlider"), &Z_Registration_Info_UClass_UAkSlider, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAkSlider), 1408783762U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_diabo_OneDrive_Desktop_audioTest_Plugins_Wwise_Source_AkAudio_Classes_AkWaapiUMG_Components_AkSlider_h_3092326692(TEXT("/Script/AkAudio"),
		Z_CompiledInDeferFile_FID_Users_diabo_OneDrive_Desktop_audioTest_Plugins_Wwise_Source_AkAudio_Classes_AkWaapiUMG_Components_AkSlider_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_diabo_OneDrive_Desktop_audioTest_Plugins_Wwise_Source_AkAudio_Classes_AkWaapiUMG_Components_AkSlider_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_Users_diabo_OneDrive_Desktop_audioTest_Plugins_Wwise_Source_AkAudio_Classes_AkWaapiUMG_Components_AkSlider_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_diabo_OneDrive_Desktop_audioTest_Plugins_Wwise_Source_AkAudio_Classes_AkWaapiUMG_Components_AkSlider_h_Statics::ScriptStructInfo),
		nullptr, 0);
