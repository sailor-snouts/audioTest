...
template<> WWISERESOURCELOADER_API UScriptStruct* StaticStruct<FWwisePlatformId>()
{
	...
	struct Z_CompiledInDeferFile_FID_Users_diabo_OneDrive_Desktop_audioTest_Plugins_Wwise_Source_WwiseResourceLoader_Public_Wwise_WwisePlatformId_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_diabo_OneDrive_Desktop_audioTest_Plugins_Wwise_Source_WwiseResourceLoader_Public_Wwise_WwisePlatformId_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_diabo_OneDrive_Desktop_audioTest_Plugins_Wwise_Source_WwiseResourceLoader_Public_Wwise_WwisePlatformId_h_201854580(TEXT("/Script/WwiseResourceLoader"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Users_diabo_OneDrive_Desktop_audioTest_Plugins_Wwise_Source_WwiseResourceLoader_Public_Wwise_WwisePlatformId_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_diabo_OneDrive_Desktop_audioTest_Plugins_Wwise_Source_WwiseResourceLoader_Public_Wwise_WwisePlatformId_h_Statics::ScriptStructInfo),
		nullptr, 0);
